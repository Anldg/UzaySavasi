...
public class GemiKontrol : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetButtonDown("Jump"))
        {
            ...
            Vector3 kursunPosizyon = gameObject.transform.position;
            kursunPosizyon.y += 1;
            //Instantiate(kursunPrefab, kursunPosizyon, gameObject.transform.rotation);
            Instantiate(kursunPrefab, kursunPosizyon, Quaternion.identity);
        }
    }

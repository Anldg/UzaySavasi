...
public class HareketKontrol : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        GetComponent<Rigidbody2D>().AddForce(new Vector2(Random.Range(-5, 5), Random.RandomRange(-5, 5)), ForceMode2D.Impulse);
    ...
    /// <summary>
    /// Objenin oyun ekranında kalmasını sağlar.
    /// </summary>
    void EkrandaKal()
    {
        Vector3 position = transform.position;
        if(position.x - colliderBoyYarim < EkranHesaplayicisi.Sol)
        {
